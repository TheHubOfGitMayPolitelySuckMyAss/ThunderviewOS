  ...
  ({ error, className = "", children, ...props }, ref) => {
    return (
      <select
        ref={ref}
        className={[
          "w-full font-sans text-[15px] text-fg1 bg-bg border rounded-md px-3.5 py-[11px] outline-none transition-[border-color,box-shadow] duration-[120ms] appearance-none",
