...
import { createDraft } from "./monday-after/actions";
...
export default function CreateMondayAfterButton({ dinnerId, dinnerLabel }: Props) {
  ...
  function handleClick() {
    startTransition(async () => {
      ...
      if (result.success && result.emailId) {
        router.push(`/admin/emails/monday-after/${result.emailId}`);
      }
    });
  }
