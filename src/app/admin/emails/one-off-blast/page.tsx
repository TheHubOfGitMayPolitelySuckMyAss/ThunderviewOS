...
export default async function OneOffBlastMacroPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-fg3 mb-6">
        Default content for new One Off Blast email drafts. Changes here will seed future drafts &mdash; they won&rsquo;t affect existing ones.
      </p>

      <MacroEditor
        initialSubject={macro.subject}
        initialBody={macro.body}
