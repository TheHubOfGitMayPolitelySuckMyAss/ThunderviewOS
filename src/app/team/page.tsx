        ...
        <div className="max-w-[1120px] mx-auto tv-page-gutter py-section">
          ...
          <div className="space-y-section">
            {team.map((member) => (
              <article
                key={member.name}
                className="flex flex-col md:flex-row gap-7 items-start"
              >
                <div className="relative w-[200px] h-[200px] md:w-[240px] md:h-[240px] flex-shrink-0 rounded-xl overflow-hidden">
                  <Image
                    src={member.photo}
                    alt={member.name}
                    fill
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Body className="max-w-[640px]">{member.bio}</Body>
                </div>
              </article>
            ))}
          </div>
