...
> = {
  approval: {
    ...
    body: [
      ...
      `<p>${emailCtaButton("Buy Your First Ticket", "https://thunderviewceodinners.com/portal/tickets")}</p>`,
  ...
  "re-application": {
    ...
    body: [
      ...
      `<p>${emailCtaButton("Grab A Ticket To The Next One", "https://thunderviewceodinners.com/portal/tickets")}</p>`,
      emailSignature(),
    ].join("\n"),
  },
  rejection: {
  ...
  fulfillment: {
    ...
    body: [
      ...
      `<p>${emailCtaButton("View The Roster", "https://thunderviewceodinners.com/portal/recap")}</p>`,
  ...
  "morning-of": {
    ...
    body: [
      ...
      `<p>${emailCtaButton("Open The Roster", "https://thunderviewceodinners.com/portal/recap")}</p>`,
  ...
  "admin-notification": {
    ...
    appendHtml: emailCtaButton("Review Application", "https://thunderviewceodinners.com/admin/applications/123"),
  },
};
