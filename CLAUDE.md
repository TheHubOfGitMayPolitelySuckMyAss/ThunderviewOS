...
- **Six transactional templates wired:** approval, re-application, rejection, fulfillment, morning-of, prompt-intro-ask. Editable at `/admin/emails/*`. From: `team@thunderviewceodinners.com`. Body uses `[member.fieldname]` placeholders.
